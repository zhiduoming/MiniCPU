module ID_EX_Register #(
    ...
    input wire ID_alu_src_C_select,
    ...
    input wire [XLEN-1:0] ID_read_data3,
    input wire [4:0] ID_rs1,
    input wire [4:0] ID_rs2,
    input wire [4:0] ID_rs3,
    ...
    output reg EX_alu_src_C_select,
    ...
    output reg [XLEN-1:0] EX_read_data3,
    output reg [4:0] EX_rs1,
    output reg [4:0] EX_rs2,
    output reg [4:0] EX_rs3,
...
always @(posedge clk or posedge reset) begin
    if (reset) begin
        ...
        if (flush) begin
            ...
            EX_alu_src_C_select <= ID_alu_src_C_select;
            EX_opcode <= ID_opcode;
            EX_funct3 <= ID_funct3;
            EX_funct7 <= ID_funct7;
            EX_rd <= ID_rd;
