...
assign interrupt_taken = (trap_handle_state == GOTO_MTVEC) &&
                         (trap_status == `TRAP_INTERRUPT);
        ...
        default: begin
            case (trap_handle_state)
                ...
                WRITE_MEPC: begin 
                    ...
                    else if (trap_status == `TRAP_INTERRUPT) csr_trap_write_data = 32'h8000000B;
